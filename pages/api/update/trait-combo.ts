...
import { getTraitCollectionAsObject, getTraitsAsObject } from "utils/traits";
...
export default async function handler(
  ...
  const collectionsObject = await getTraitCollectionAsObject();
  ...
  for (const trait_type of Object.keys(traitsObject)) {
    ...
    const trait_net_total = (trait_values_obj[traitKeys[0]] as any)
      .trait_net_total;
